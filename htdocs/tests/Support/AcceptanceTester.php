...
class AcceptanceTester extends \Codeception\Actor
{
    ...
    /**
     * @When I record the :arg1
     */
     public function iRecordThe($arg1)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I record the :arg1` is not defined");
     }

    /**
     * @When I input the :num1-digit code to :arg1
     */
     public function iInputThedigitCodeTo($num1, $arg1)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I input the :num1-digit code to :arg1` is not defined");
     }
    ...
    /**
     * @Then I see :arg1 or :arg2
     */
     public function iSeeOr($arg1, $arg2)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I see :arg1 or :arg2` is not defined");
     }

    /**
     * @Then I should not see :arg1 or :arg2
     */
     public function iShouldNotSeeOr($arg1, $arg2)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I should not see :arg1 or :arg2` is not defined");
     }

    /**
     * @Given I input my :num1-digit code to :arg1
     */
     public function iInputMydigitCodeTo($num1, $arg1)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I input my :num1-digit code to :arg1` is not defined");
     }
    ...
    /**
     * @Given I fill in :arg1, :arg2, :arg3 and :arg4
     */
     public function iFillInAnd($arg1, $arg2, $arg3, $arg4)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I fill in :arg1, :arg2, :arg3 and :arg4` is not defined");
     }
    ...
    /**
     * @Given I fill in item_name:arg1item_price:arg1item_description:arg3item_image"
     */
     public function iFillInItem_nameitem_priceitem_descriptionitem_image($arg1, $arg2, $arg3)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I fill in item_name:arg1item_price:arg1item_description:arg3item_image"` is not defined");
     }

    /**
     * @Then I do not see :arg1
     */
     public function iDoNotSee($arg1)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I do not see :arg1` is not defined");
     }

    /**
     * @Given I click :arg1 on :arg2
     */
     public function iClickOn($arg1, $arg2)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I click :arg1 on :arg2` is not defined");
     }

    /**
     * @Then I see :arg1 in my cart
     */
     public function iSeeInMyCart($arg1)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I see :arg1 in my cart` is not defined");
     }

    /**
     * @Then I see :arg1  in my watchlist
     */
     public function iSeeInMyWatchlist($arg1)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I see :arg1  in my watchlist` is not defined");
     }

    /**
     * @Given I have :arg1 with :arg2 in my :arg3
     */
     public function iHaveWithInMy($arg1, $arg2, $arg3)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I have :arg1 with :arg2 in my :arg3` is not defined");
     }
     ...
     */
     ...
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I click the :arg1` is not defined");
     }

    /**
     * @When I input :arg1 and :arg2
     */
     public function iInputAnd($arg1, $arg2)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I input :arg1 and :arg2` is not defined");
     }

    /**
     * @Then I see my message on :arg1
     */
     public function iSeeMyMessageOn($arg1)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I see my message on :arg1` is not defined");
     }

    /**
     * @When I do not input :arg1 and :arg2
     */
     public function iDoNotInputAnd($arg1, $arg2)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I do not input :arg1 and :arg2` is not defined");
     }

    /**
     * @Then I do not see my message on :arg1
     */
     public function iDoNotSeeMyMessageOn($arg1)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I do not see my message on :arg1` is not defined");
     }

    /**
     * @Given I fill in :arg1, :arg2, :arg3
     */
     public function iFillIn($arg1, $arg2, $arg3)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I fill in :arg1, :arg2, :arg3` is not defined");
     }

    /**
     * @Given I am on :arg1 or :arg2
     */
     public function iAmOnOr($arg1, $arg2)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I am on :arg1 or :arg2` is not defined");
     }

    /**
     * @Given I fill do not fill in :arg1, :arg2, :arg3 or :arg4, :arg5, :arg6
     */
     public function iFillDoNotFillInOr($arg1, $arg2, $arg3, $arg4, $arg5, $arg6)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I fill do not fill in :arg1, :arg2, :arg3 or :arg4, :arg5, :arg6` is not defined");
     }

    /**
     * @Then I do not see :arg1 or :arg2
     */
     public function iDoNotSeeOr($arg1, $arg2)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I do not see :arg1 or :arg2` is not defined");
     }
     ...
     */
     ...
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I fill in :arg1` is not defined");
     }

    /**
     * @Then I see my review on :arg1
     */
     public function iSeeMyReviewOn($arg1)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I see my review on :arg1` is not defined");
     }

    /**
     * @Then I see reviews for :arg1 on :arg2
     */
     public function iSeeReviewsForOn($arg1, $arg2)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I see reviews for :arg1 on :arg2` is not defined");
     }
    ...
    /**
     * @When I click on the :arg1 icon
     */
     public function iClickOnTheIcon($arg1)
     {
         throw new \PHPUnit\Framework\IncompleteTestError("Step `I click on the :arg1 icon` is not defined");
     }
