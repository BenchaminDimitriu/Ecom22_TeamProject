...
<h2 class="text-center mb-5"><?=_("Review Item")?></h2>

<form action='' method='post' enctype='multipart/form-data'>
  <label for="quantity">Rate (between 1 to 5):</label>
  <input type="number" id="quantity" name="rating" min="1" max="5">
</br>
</br>

<label><?=_("Comment:")?><textarea rows="4" cols="50" maxlength="50" class="form-control form-control-lg" rows="3" name='comment'></textarea></label></br>
</br>
</br>

<button type="submit"class="btn btn-success btn-block btn-lg gradient-custom-4" name="action"><?=_("Submit Review")?></button>
</form>
