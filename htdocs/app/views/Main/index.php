 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
   ...
   <form action="/Main/search" method="get" style='display:inline-block'>         
      ...
      <tr><th>Name</th><th>Price</th><th>Description</th><th>Image</th><th>Action</th><th>Action</th><th>Action</th><th>Action</th></tr>
                          ...
                          <td type=action>
                          <button  class='btn btn-info'><a class='nav-link' href='/Seller/delete/$item->seller_id'>Contact seller</a></button>
                          </td>
                          <td type=action>
                          <button  class='btn btn-secondary'><a class='nav-link' href='/Seller/delete/$item->item_id'>Add to watchlist</a></button>
                          </td>
                      		<td type=action>
                      	  <button  class='btn btn-dark'><a class='nav-link' href='/Seller/delete/$item->item_id'>Add to cart</a></button>
                      		</td>
                            <td type=action>
                          <button  class='btn btn-warning'><a class='nav-link' href='/Seller/delete/$item->item_id'>Bid</a></button>
                          </td>
                      		</tr>";
                      	}
                      ?>
